...
QString TransString::getTransString(TransStrType type)
{
    static QMap<TransStrType, const char *> gTransMap = {
        {STRING_CLOUDTITLE , QT_TR_NOOP("UOS Cloud Sync")},
        ...
        {STRING_LOCALTITLE , QT_TR_NOOP("Link local accounts to UOS ID")},
        {STRING_LOCALMSG , QT_TR_NOOP("If linked, you can use UOS ID to log in and reset passwords of local accounts. Switch it off to get them unlinked.")},

        {STRING_DEVTITLE , QT_TR_NOOP("Trusted devices")},
        {STRING_DEVMSG , QT_TR_NOOP("Manage trusted devices to keep your UOS ID secure.")},
        ...
        {STRING_CLOUDSV , QT_TR_NOOP("Cloud Service of UOS ID")},
        {STRING_CLOUDTITLEMSG , QT_TR_NOOP("Manage your UOS ID and sync your personal data across devices.\nSign in to UOS ID to get personalized features and services of Browser, App Store, Support, and more.")},
        {STRING_LOGIN , QT_TR_NOOP("Sign In to UOS ID")},

        {STRING_CLOUDITEM , QT_TR_NOOP("UOS Cloud")},
        ...
        {STRING_MSGPHONE , QT_TR_NOOP("Use the trusted mobile number or email address to sign in to UOS ID, and verify sensitive operations if they are performed on UOS ID.")},
        {STRING_PHONEBIND , QT_TR_NOOP("Link phone number to UOS ID")},
        {STRING_MAILBIND , QT_TR_NOOP("Link email address to UOS ID")},
        {STRING_WECHATTITLE , QT_TR_NOOP("Link third-party accounts")},
        {STRING_WECHATMSG , QT_TR_NOOP("Securely and quickly log in to your UOS ID and local account by scanning the QR code with the linked WeChat.")},
        {STRING_WECHATUNBINDTITLE , QT_TR_NOOP("If unlinked, you will not be able to use WeChat to sign in to UOS ID.")},
        {STRING_WECHATUNBINDMESSAGE , QT_TR_NOOP("Are you sure you want to unlink it?")},
        {STRING_PASSWORDTITLE , QT_TR_NOOP("Password")},
        {STRING_PASSWORDMSG , QT_TR_NOOP("Change your UOS ID password regularly to ensure its security.")},
        ...
        {STRING_REBINDPHONE , QT_TR_NOOP("The phone number has been linked to UOS ID: %1.\nPlease check and choose one action below.")},
        {STRING_REBINDMAIL , QT_TR_NOOP("The email address has been linked to UOS ID: %1.\nPlease check and choose one action below.")},
        ...
        {STRING_RESETPWDTITLE , QT_TR_NOOP("Change UOS ID password")},
        {STRING_FORGETPWD , QT_TR_NOOP("Forgot password?")},
        {STRING_BINDLOCAL , QT_TR_NOOP("Link to current UOS ID")},
        ...
        {STRING_WECHATBIND , QT_TR_NOOP("Link WeChat to UOS ID")},
